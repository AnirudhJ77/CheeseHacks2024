...
export default function RecordingView() {
    ...
    const processToWav = async (blob: Blob): Promise<Uint8Array> => {
        ...
        wav.fromScratch(1, sampleRate, "16", pcmData); // Mono, desired sample rate, 16-bit
        return wav.toBuffer();
    };
    ...
    return (
        <div className="flex items-center justify-center h-screen w-full">
            <div className="">
                <h1 className="animate-pulse text-center text-9xl font-mono font-bold text-amber-800 opacity-60">
                    ShaMeow
                    <p className="text-center text-xl font-mono font-bold text-amber-800 opacity-60">
                ...
                <div className="flex items-center w-full">
                    {isRecording ? (
                        ...
                        <button onClick={handleToggleRecording}
                            className="rounded-full w-40 h-40 mt-10 m-auto flex items-center justify-center bg-amber-500 opacity-80 hover:bg-amber-600"
                        >
                            <svg
                                className="w-24 h-24"
                                xmlns="http://www.w3.org/2000/svg"
